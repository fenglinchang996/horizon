...
|---|---|---|
| r | Allows a file to be opened and read. | Allows a directory’s contentts to be listed if the execute attributes is also set. | 
| w | Allows a file to be written to or truncated; however, this attributes does not allow files to be renamed or deleted. The ability to delete or rename files is determined by directory attributes. | Allows files within a directory to be created, deleted, and renamed if the execute attributes is also set. | 
...
- Two distinct ways of specifying mode changes:
   ...
   - Octal number representation
      ...
      ![](https://www.yuval.guide/linux/permissions.jpg)
   ...
   - Symbolic representation
      ...
      | g | Group owner. | 
      | o | Shorts for “others“ but means world. | 
      | a | Shorts for “all”. This is a combination of u, g and o. | 
...
- The administrator can configure `sudo` to allow an ordinary user to execute commands as a different user (usuallay superuser) in a controlled way. 
